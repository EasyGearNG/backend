...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h2>Dear {{ $name }},</h2>
            <p>Your recent order has been successfully completed, and your payment settlement has been processed.</p>

            <div class="order-ref">Order Reference: <span>#{{ $orderRef }}</span></div>

            <p>You can view your earnings, transaction details, and settlement history from your vendor dashboard.</p>

            <div style="text-align: center;">
                <a href="{{ $dashboardUrl }}" class="button">View Wallet & Earnings</a>
            </div>

            <p>Thank you for providing an excellent shopping experience to our customers.</p>
