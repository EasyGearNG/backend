...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background-color: #dbeafe; color: #1e40af; padding: 6px 16px; border-radius: 999px; font-weight: bold; font-size: 14px; margin-bottom: 20px; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h2>Dear {{ $name }},</h2>
            <p>You have received a new order on {{ $appName }}.</p>

            <div class="order-ref">Order Reference: <span>#{{ $orderRef }}</span></div>

            <p>Please log in to your vendor dashboard to view the order details and begin processing the shipment.</p>
            <p>Timely order fulfilment helps improve customer satisfaction and your vendor performance rating.</p>
